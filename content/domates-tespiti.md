...
Technologies: Python, OpenCV, YOLO, PyTorch, Android (Kotlin), FastAPI

The related paper is currently under review, so the trained model is kept private and the live demo below requires a password.
