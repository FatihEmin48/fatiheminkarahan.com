...
Araçlar: Python, OpenCV, YOLO, PyTorch, Android (Kotlin), FastAPI

İlgili makale şu anda değerlendirme aşamasında olduğu için eğitilen model gizli tutulmaktadır; aşağıdaki canlı demoyu kullanmak için şifre gereklidir.
